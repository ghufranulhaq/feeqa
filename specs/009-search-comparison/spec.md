...
- **FR-009-11** The best value per row is highlighted, but **no overall winner** is declared. Columns for `unclaimed` businesses show the notice from 008 FR-008-10a.
...
- **Decided (2026-09-24):** no sponsored slots on profile pages. Launch comparisons use the travel question sets (travel-content.md), with the Airlines rows ordered punctuality, disruption handling, baggage, crew, seat comfort.
