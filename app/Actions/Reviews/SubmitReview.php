...
/**
 * FR-003-02, FR-003-04, FR-003-06 through FR-003-09: the core submission
 * rules that apply before question-set answers (T4), drafts (T5), or
 * proper source labelling (T7) exist. Source label is always `Organic`
 * here — T7 wires the invitation/redirect paths.
 */
class SubmitReview
{
     ...
     * } $data
     */
    public function handle(User $reviewer, Business $business, array $data): Review
    {
